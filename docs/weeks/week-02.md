...
原版の第2回PPTでは、「**人間も間違えるし、センサも間違える**」という視点から誤差を導入しています。
...
原版PPTでは、誤差の表し方に関連して**有効数字**も扱っています。
...
原版講義では、第2回の中で誤差の考え方とあわせて、**平均・分散・標準偏差**による計測データの見方も導入されています。
...
原版講義では、2組の計測データ A・B を比較して、どちらがより**正確**または**精密**かを判断する練習が入っています。
...
という形で、実測データから誤差とばらつきを考える構成になっています。

### 11.3 確率誤差の練習

原版では、次のような反復計測データを用いて平均値と確率誤差を求める演習もあります。
...
::: warning 補足
本ページでは「確率誤差」の厳密な導出までは扱わず、第3週以降の統計処理につながる導入として位置づけます。
:::
