...
|---|---|---|---|
| ダイヤフラム式構造 | 圧力 | 圧力が加わる → 薄い膜がたわむ → ひずみや変位が生じる | ひずみ・変位 |
| ピエゾ抵抗式圧力センサ | 圧力 | 圧力でダイヤフラムが変形する → 抵抗が変化する | 抵抗変化・電圧 |
| MEMS圧力センサ | 圧力 | 微小なダイヤフラムが変形する → 抵抗や容量が変化する | 電圧・デジタル値 |
| 静電容量式圧力センサ | 圧力 | 圧力で電極間距離が変わる → 静電容量が変わる | 静電容量 |
| LC共振読み出し | 静電容量変化 | 容量が変わる → 共振周波数が変わる | 周波数 |
| 圧電式圧力センサ | 変動圧力・衝撃 | 力が変化する → 圧電材料に電荷が発生する | 電荷・電圧 |
| FSR | 押す力・接触 | 押す → 導電経路が増える → 抵抗が下がる | 抵抗変化 |
| 感圧ゴム | 接触・圧力分布 | 圧力で導電粒子の接触状態が変わる → 抵抗が変わる | 抵抗変化 |
| 分布圧センサアレイ | 面圧分布 | 多数のセルがそれぞれ圧力を受ける → セルごとの抵抗や容量が変わる | 圧力マップ |
| 触覚センサ | 接触位置・圧力分布・滑り | 接触で表面が変形する → セル値や画像が変化する | 圧力分布・画像 |
| 光学触覚センサ | 接触・せん断・滑り | 弾性体が変形する → カメラ画像上のマーカーや模様が動く | 画像変化 |
